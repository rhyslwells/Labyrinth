...
class Actor:
    ...
    def make_decision(self, environment):
        """
        Decide on the next move based on the surroundings.
        For the base class, we'll just move randomly.
...
for step in range(5):
    ...
    env.place_actor(actor.position, "A")  # Use 3 to represent the actor
    env.display()
