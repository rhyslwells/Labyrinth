...
predefined_moves = "RRRRRDDDLLLLLDDD"
...
# What happens if the actor tries to move off the grid? They should be not be permited to move in that direction, ie that do not move that way. 
# What happens if the actor tries to move into an obstacle? Similarly