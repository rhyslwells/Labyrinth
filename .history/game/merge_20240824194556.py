...
class ActorWorld(gym.Env):

    def __init__(self, world='7x7-simple', delay=0):

        file = open(CURRENT_PATH/f"Actorworld_assets/Actorworld_maps/{world}.csv") # 
        ...
        I only want a simple coloured cell for each sprite below.
        ...
        self.Actor = pygame.transform.scale(pygame.image.load(Actor_tile_path), (sprite_dims_x, sprite_dims_y))
    ...
    def render(self, mode="human"):
        ...
        self.window.blit(self.Actor, (self.current_pos[0] * self.sprite_dims_x, self.current_pos[1] * self.sprite_dims_y))
        self.clock.tick(FPS)
