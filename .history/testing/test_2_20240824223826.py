...
from components.utils.rendering import GameWindow  # Assuming this is an additional class for visualization

FPS = 30


# Create a Game instance
game = Game(name='SimpleGridGame', world='7x7-simple-walls', delay=100)
